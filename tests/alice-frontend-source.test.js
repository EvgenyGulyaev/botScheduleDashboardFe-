...
test('admin users view manages visibility groups and alice permission payload', () => {
  ...
  assert.match(source, /selectedVisibilityGroups/)
  assert.match(source, /newVisibilityGroupInput/)
  assert.match(source, /addVisibilityGroup/)
  assert.match(source, /removeVisibilityGroup/)
  assert.match(source, /collectVisibilityGroupOptions/)
  assert.match(source, /visibility_groups:\s*normalizeVisibilityGroups/)
